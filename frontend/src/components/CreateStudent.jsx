...
function CreateStudent() {
    ...
    const handleSubmit = () => {
        if (Name !== '' && Email !== '') {
            axios.post('http://localhost:3002/CreateStudent', { Name, Email })
    ...
    return (
        <div className='bg-blue-700 min-h-screen flex justify-center items-center'>
            ...
            <h1 className='font-bold text-3xl absolute top-[40px] left-[100px]'>Add New Student</h1>
                <div>
                ...
                <button 
                    ...
                    className='bg-green-500 mx-[180px] p-3 rounded-lg shadow-md shadow-black'
                >
                    Submit
                </button>
            </div>
